...
const MORNING = [{name: "Now", subpages: [{name: "current-page", duration: 10000}, {name: "radar-page", duration: 7000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 15000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 15000},{name: "7day-page", duration: 15000}]},]
const NIGHT = [{name: "Now", subpages: [{name: "current-page", duration: 10000}, {name: "radar-page", duration: 7000}]},{name: "Tomorrow", subpages: [{name: "tomorrow-page", duration: 15000}]},{name: "Beyond", subpages: [{name: "tomorrow-night-page", duration: 15000}, {name: "7day-page", duration: 15000}]},]
const SINGLE = [{name: "Alert", subpages: [{name: "single-alert-page", duration: 7000}]},{name: "Now", subpages: [{name: "current-page", duration: 10000}, {name: "radar-page", duration: 5000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 10000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 10000}, {name: "tomorrow-page", duration: 10000}, {name: "7day-page", duration: 10000}]},]
