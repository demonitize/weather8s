...
const STANDBYSINGLE = [
  { name: "Alert", subpages: [{ name: "single-alert-page", duration: 10000 }] },
  { name: "Now", subpages: [{ name: "current-page", duration: 10000 }] },
  { name: "Today", subpages: [{ name: "today-page", duration: 10000 },{ name: "tonight-page", duration: 10000 }] },
  {
    name: "Beyond",
    subpages: [
      { name: "tomorrow-page", duration: 5000 },
      { name: "tomorrow-night-page", duration: 5000 },
...
const STANDBYMULTI = [
  {
    name: "Alerts",
    subpages: [{ name: "multiple-alerts-page", duration: 10000 }],
  },
  { name: "Now", subpages: [{ name: "current-page", duration: 10000 }] },
  { name: "Today", subpages: [{ name: "today-page", duration: 10000 },{ name: "tonight-page", duration: 10000 }] },
  {
...
const DEBUGSEQUENCE = [
  {
    name: "Now",
    subpages: [
      { name: "current-page", duration: 3000 },
    ],
  },
  { name: "Today", subpages: [{ name: "today-page", duration: 3000 },{ name: "tonight-page", duration: 3000 }] },
  { name: "Tomorrow", subpages: [{ name: "tomorrow-page", duration: 3000 },{ name: "tomorrow-night-page", duration: 3000 }] },
  {
    name: "Beyond",
    subpages: [
      { name: "7day-page", duration: 3000 },
    ],
  },
];
...
var music = new Gapless5({
  tracks: [
    "https://demonitize.github.io/weather8s/assets/music/StandbyMode_3.wav",
  ],
  loop: true,
  loadLimit: 1,
...
function executePage(pageIndex, subPageIndex) {
  ...
  console.log(`SubIndex: ${subPageIndex}`);
  console.log(`CurrentPage: ${JSON.stringify(currentPage)}`);
  console.log(`CurrentSubPageName: ${currentSubPageName}`);
...
function playMultiVoice(files) {
  if (typeof files != Array)
    return console.warn(
      `Expected "files" to be of type "Array", but found type "${typeof files}. Aborting playMultiVoice"`
    );
...
function playCurrentConditionsVoice(temp, condition) {
  voice = new Audio(
    `assets/MegaPack/Narrations/Current Conditions/CC_INTRO2.wav`
  );
  music.volume = 0.25;
  voice.volume = 0.25;
  voice.play();
  voice.onended = function () {
    if (temp < 0) {
      voice = new Audio(
        `assets/MegaPack/Narrations/Current Conditions/M${temp}.mp3`
      );
    } else {
      voice = new Audio(
        `assets/MegaPack/Narrations/Current Conditions/${temp}.mp3`
      );
    }
    voice.play();
    voice.onended = function () {
...
function endSequence() {
  if (CONFIG.standbyMode) executePage(0, 0);
